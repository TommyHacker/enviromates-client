...
const AllEvents = () => {
	// choose between listing events or single map to browse the area
	...
	return (
		<>
			...
			<Container className='p-4 d-flex justify-content-center'>
				<Button className='w-25' onClick={() => setMapView(!mapView)}>
											...
											<Accordion.Item eventKey='0'>
												<Accordion.Header>
													<h2 className='event-title'>
														{event.title} <br />
														<span className='mt-2 challenge-info'>
															{' '}
															Challenge Level: {event.difficulty}{' '}
														</span>
													</h2>
												</Accordion.Header>
												<Accordion.Body className='backgroundColor'>
													<div className='mb-5'>
														<h4>
															<span className='title-main mt-2'>
																{capitalize(event.title)}
															</span>
														</h4>
														<div
															onClick={() => navigateHandler(event.id)}
															key={index}>
															<h5 className='fs-6 mt-3 mb-4'>
